    ...
    <div>
      <section className="mt-[100px] grid py-3 px-6 gap-4 md:flex md:max-w-[1320px] md:justify-between  md:max-h-[684px] justify-center mx-auto lg:mt-[223px] mb-24 lg:mb-[300px] ">
        <div className="grid max-w-[900px] gap-4 lg:gap-14 md:flex md:flex-col relative">
          <p className=" text-hard-color text-lg lg:text-[30px]">
            Hi, my name is
          </p>
          <h1 className=" text-[#cdd6f6] text-4xl lg:text-[120px] font-black">
            Gabriel Nuñez
          </h1>
          <h2 className=" text-[#8992af] text-2xl font-black lg:text-[50px] leading-tight">
            Full Stack Developer, writing code with passion.
          </h2>
          <section className="flex gap-7 mt-3 z-10 lg:gap-14">
          ...
          <h1 className="text-hard-color md:text-xl md:text-end">
